...
async function addPlayersToFirestore() {
  const playersData = `Name,University,Category,Total Runs,Balls Faced,Innings Played,Wickets,Overs Bowled,Runs Conceded
...
Tharindu Embuldeniya,University of the Visual & Performing Arts,All-Rounder,264,220,12,12,60,360`;
  ...
  for (let i = 1; i < lines.length; i++) {
    ...
    for (let j = 0; j < headers.length; j++) {
      ...
      playerData[headers[j].trim()] = value;
    }
